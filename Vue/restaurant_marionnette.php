...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<!-- Titre du site -->
		<title>AssuranceTourix | Restaurant marionnette</title>
	</head>
	...
	<body>
		...
		<div class="carte_restaurant">
			<a class="btn btn-success" href="../images/restaurant_marionnette.pdf" title="Pdf">Télécharger la carte (PDF)</a>
			<div class="row">
				<img src="../images/restaurant_marionnette.PNG">
				<img src="../images/restaurant_marionnette2.PNG">
			</div>
		</div>
	</body>
</html>