...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<!-- Titre du site -->
		<title>AssuranceTourix | Restaurant relais gaulois</title>
	</head>
	...
	<body>
		...
		<div class="carte_restaurant">
			<a class="btn btn-success" href="../images/restaurant_relais.pdf" title="Pdf">Télécharger la carte (PDF)</a>
			<div class="row">
				<img src="../images/restaurant_relais.PNG">
			</div>
		</div>
	</body>
</html>