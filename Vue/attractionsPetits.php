...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<!-- Titre du site -->
		<title>AssuranceTourix | Attractions pour les plus petits</title> 
	</head> 
			...
			<?php
				...
				?>
					<div class="col-md-7 images_attraction">
						<img src="../images/<?php echo $tableau_images[$i];?>.jpg" class="img-rounded" alt="" width="50%" align="right">
					</div>
					<div class="col-md-5 texte_annexe">
						<h2><?php echo $res[$i]['nom']?></h2>
						<div>
							<span>Taille minimum : <?php echo $res[$i]['taille']?> cm</span><br>
							<span>Attraction Familiale, À ne pas rater</span><br>
