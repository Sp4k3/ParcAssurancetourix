...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<!-- Titre du site -->
		<title>AssuranceTourix | Restaurant du lac</title>
	</head>
	...
	<body>
		...
		<div class="carte_restaurant">
			<a class="btn btn-success" href="../images/restaurant_lac.pdf" title="Pdf">Télécharger la carte (PDF)</a>
			<div class="row">
				<img src="../images/restaurant_du_lac.PNG">
			</div>
		</div>
	</body>
</html>